...
public class JogoRNComputador {
    ...
    private char[][] lances;
    /**Variável necessária para verificar se houve vitória no lance corrente*/
     ...
     */
    public JogoRNComputador(JButton buttonMatriz[][], int x, int y, JTextField placar1, JTextField placar2) {
